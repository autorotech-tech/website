...
_Спасибо авторам и контрибьюторам [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) за актуальный `design-md/cursor/DESIGN.md` (MIT)._

_Источник: тот же репозиторий, файл `design-md/cursor/DESIGN.md`._

**Обновление одной командой:** `npm run design:sync-cursor`

Вручную:

```bash
curl -fsSL -o DESIGN.md "https://raw.githubusercontent.com/VoltAgent/awesome-design-md/main/design-md/cursor/DESIGN.md"
cp DESIGN.md .cursor/skills/refero-cursor-warm-ivory/reference-DESIGN.md
```

_(После только `curl` блок «спасибо» пропадёт — снова выполните `npm run design:sync-cursor`.)_
