...
| Дата | Что |
|------|-----|
| 2026-08-27 | ATS symbiosis: generate RAG context pack (`job_responder_rag_pack.py`) + `CandidateProfile`/`JobDescription` schemas; doc [ats-pipeline-symbiosis.md](./ats-pipeline-symbiosis.md) (research + recruiter reverse bridge) |
