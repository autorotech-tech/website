              ...
              <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  ...
                  <div className="md:col-span-3">
                    ...
                    >
                      <option value="support">support (поддержка) — отвечает по базе знаний, без воронки продаж</option>
                      <option value="sales">sales (продажник) — консультант: 2-3 варианта из базы, без жестких продаж</option>
                    </select>
                    <div className="text-xs text-gray-400 mt-1">Роль задаёт логику общения (промпты админа Autoro) и Base RAG при индексации. Telegram-бот видит только вашу базу знаний.</div>
                  </div>
