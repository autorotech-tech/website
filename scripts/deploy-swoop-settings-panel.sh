...
for f in main.py hermes_media.py swoop_provider_catalog.py swoop_lmarena.py swoop_mimo.py swoop_kimi.py swoop_openmodel.py swoop_serpapi.py swoop_google_cse.py swoop_bing_webmaster.py swoop_groq.py swoop_parsing.py swoop_expired_domains.py kb_file_ingest.py security.py job_responder.py; do
